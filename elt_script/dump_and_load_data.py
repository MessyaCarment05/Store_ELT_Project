...
subprocess.run(dump_command, env={'PGPASSWORD': os.getenv("POSTGRES_PASSWORD_SOURCE")}, check=True)
...
subprocess.run(load_command, env={'PGPASSWORD': os.getenv("POSTGRES_PASSWORD_DEST")}, check=True)
